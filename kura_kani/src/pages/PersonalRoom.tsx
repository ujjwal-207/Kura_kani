...
const Table = ({
  ...
  return (
    <div className="flex flex-col items-start gap-2 xl:flex-row back">
...
const PersonalRoom = () => {
  ...
  const meetingLink = `${"http://localhost:5173/"}||{"https://kura-kani-r9ks.onrender.com/"}/meeting/${meetingId}?personal=true`;
